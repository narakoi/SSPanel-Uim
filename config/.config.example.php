...
# - 2          = 使用下方配置的等级
# - 0 or other = 所有用户
$_ENV['Trojan_allow_User_Type']   = 0;
$_ENV['Trojan_allow_User_Class']  = [];        //格式为PHP数组，允许使用Trojan节点的用户等级，上方配置为 2 时生效
$_ENV['Trojan_node_Traffic_Rate'] = 1.0;       //Trojan节点的流量倍率，对所有节点生效
$_ENV['Trojan_bear_node']         = 0;         //Trojan流量记录承载节点，即所有Trojan的流量都以此节点展示，为 0 表示不添加流量记录
